    ...
    return (
        <div id="body" className="font-system bg-bg-dark text-text-primary min-h-screen flex flex-col items-center p-[20px] supports-[height:100dvh]:min-h-dvh">
            ...
            <div id="resultsScreen" className="flex flex-col items-center gap-[25px] text-center max-w-[800px] w-full flex-grow">
                ...
                <span id="score" className="text-primary text-[3rem] font-bold m-[40px] sm:text-[5rem]">0 / 0</span>
                ...
                <div id="button-row" className="flex flex-col gap-[12px] mt-[15px] justify-center items-center w-full">
                    <button className="bg-secondary hover:bg-secondary-hover text-bg-dark border-none rounded-lg font-bold cursor-pointer w-full py-3 text-[1em] font-sans max-w-[200px] sm:text-[1.1em] sm:max-w-[250px]">Restart</button>
                    <button className="bg-bg-light hover:bg-bg-lighter text-text-primary border-none rounded-lg font-bold cursor-pointer w-full py-3 text-[1em] font-sans max-w-[200px] sm:text-[1.1em] sm:max-w-[250px]">Main Menu</button>
                </div>
